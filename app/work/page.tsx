    ...
    <section className="py-20">
      <div className="max-w-3xl">
        ...
        <p className="mt-6 text-lg text-neutral-600">
          I’m a technical SEO by trade, but brand visibility doesn’t end with meta tags.
          I’m often dropped into the messy middle of marketing teams and I become the
          operational glue between c-suite, business owners, marketing and engineering.
        </p>
        ...
        <div className="mt-12">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="rounded-lg border border-neutral-200 p-3 text-sm">
              Content — keyword research & mapping, briefs, internal linking at scale.
            </div>
            <div className="rounded-lg border border-neutral-200 p-3 text-sm">
            ...
            <div className="rounded-lg border border-neutral-200 p-3 text-sm">
              Team &amp; ops — hiring, training, hands-on leadership.
            </div>
          </div>
        </div>
      </div>
